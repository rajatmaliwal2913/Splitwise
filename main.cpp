...
// Function to calculate and print the minimum cash flow to settle all debts given a graph of transactions
void calculateMinCashFlow(int graph[][NUM_PEOPLE]) {
    int amount[NUM_PEOPLE] = {0};

    // Compute the net amount to be settled by each person
...
int main() {
    int graph[NUM_PEOPLE][NUM_PEOPLE] = {{0, 1000, 2000},
                                         {0, 0, 5000},
                                         {0, 0, 0}};
    // Calculate and display the minimum cash flow
